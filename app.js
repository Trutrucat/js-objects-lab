...
*/
game.party.push(pokemon[24], pokemon[38], pokemon[148])
...
const gymTally = {completed: 0, incomplete: 0};
  for (completed in game.gyms){
    console.log(`${completed = true}: ${game.gyms[incomplete = false]}`);
  }
...
console.log("Total number of pokemon in the party:", partyCount());
/*
Exercise 16
